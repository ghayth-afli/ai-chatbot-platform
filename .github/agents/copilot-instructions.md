...
- 002-landing-page-spec: Added React 18 (JavaScript/JSX) on Node.js 18 LTS + npm 9; Tailwind CSS 3.x for styling. + React Router v6.21, i18next + react-i18next, Tailwind CSS/PostCSS pipeline, Axios (already present though unused this phase), React Testing Library + Jest for UI tests.
